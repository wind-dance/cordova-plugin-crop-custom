...
- (void) cropImage: (CDVInvokedUrlCommand *) command {
    ...
    int crop_w = [crop_width intValue];
    int crop_h = [crop_height intValue];
    // id crop_type = options[@"crop_type"];
    CGFloat crop_ratio = crop_w / crop_h;
    CGFloat width_ratio = length;
    CGFloat height_ratio = length / crop_ratio;
    // MF CUSTOM CODE
