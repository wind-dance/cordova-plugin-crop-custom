...
public class CropPlugin extends CordovaPlugin {
    ...
    public boolean execute(String action, JSONArray args, final CallbackContext callbackContext) throws JSONException {
      if (action.equals("cropImage")) {
          ...
          // MF CUSTOM CODE
          this.crop_width = params.getInt("crop_width");
          this.crop_height = params.getInt("crop_height");
          if (params.has("crop_type")) {
              this.crop_type = params.getString("crop_type");
          } else {
              this.crop_type = "square";
          }
          // MF CUSTOM CODE
          ...
          Crop.of(this.inputUri, this.outputUri)
            .withAspect(this.crop_width,this.crop_height)
